...
class BaseServer(Document, TagHelpers):
	...
	def get_agent_repository_url(self):
		...
		repository_owner = (settings.agent_repository_owner or "frappe").strip()
		if repository_owner.startswith(("http://", "https://", "ssh://", "git@", "file://", "/")):
			return repository_owner
		return f"https://github.com/{repository_owner}/agent"

	def get_agent_repository_branch(self):
		settings = frappe.get_single("Press Settings")
		return settings.branch or "develop"
