...
try:
	...
	ImageSourceViaObjectStorageUriDetails = None
...
class VirtualMachineImage(Document):
	...
	def create_image(self):
		...
		if cluster.cloud_provider == "AWS EC2":
			...
			if not (ComputeClient and CreateImageDetails and ImageSourceViaObjectStorageUriDetails):
				frappe.throw("OCI Python SDK is required for OCI image operations.")
