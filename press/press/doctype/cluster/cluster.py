...
try:
	...
	VirtualNetworkClient = None
	AddNetworkSecurityGroupSecurityRulesDetails = AddSecurityRuleDetails = None
	CreateInternetGatewayDetails = CreateNetworkSecurityGroupDetails = None
	CreateSubnetDetails = CreateVcnDetails = None
	PortRange = RouteRule = TcpOptions = UdpOptions = UpdateRouteTableDetails = None
	IdentityClient = None
