<template>
	...
	>
		<LoginBox
			title="برای شروع یک برنامه انتخاب کنید"
			subtitle="برنامه‌ای را که می‌خواهید روی سایت نصب شود انتخاب کنید."
		>
			...
			<div v-else>
				...
				<Button
					class="mt-4 w-full"
					:label="selectedApp ? `نصب ${selectedApp.title}` : 'نصب برنامه'"
					variant="solid"
