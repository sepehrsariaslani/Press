	...
	<div>
		...
		>
			<div class="prose prose-sm max-w-none">
				<h1 class="text-2xl font-semibold">بنچ‌ها</h1>
				<p class="text-p-base">
					با بنچ‌ها کنترل بیشتری دارید. می‌توانید انتخاب کنید کدام اپ‌ها اضافه
					یا بروزرسانی شوند، روی کدام ریجن دیپلوی شوند و خیلی موارد دیگر.
				</p>
			</div>
			<div class="space-y-3">
	...
	data() {
		return {
			features: [
				'دیپلوی کانتینری',
				'دیپلوی اپ سفارشی',
				'دسترسی به بیش از ۱۵۰ اپ مارکت‌پلیس',
				'چند محیطی (مثل Staging و Production)',
				'اسکریپت‌های سرور',
				'دسترسی SSH',
				'ورکرهای اختصاصی',
			],
